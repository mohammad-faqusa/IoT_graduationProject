class Device{
    ...
    stringInfo(){
        return `name : ${this.name}, id: ${this.id}, location: ${this.location}, peripherals: ${JSON.stringify(this.dictVariables)}, status: ${this.status}`
    }

    get pList() {
        return Object.keys(this.dictVariables) 
    }
